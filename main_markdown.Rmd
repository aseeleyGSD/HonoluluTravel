...
```{r message=FALSE, warning=FALSE, results='hide'}
tracts_KM <- st_read('/Users/marinaribeiro/Documents/2. Academic Career/3. MA Degree/Harvard GSD/4. Terms/4. Spring 2023/SES 5394 Travel Behavior and Forecasting/2. Assignments/A02 Zonal Statistics/HonoluluTravel/Tracts_KM.geojson')
```
