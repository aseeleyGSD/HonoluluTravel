...
hist01 <- ggplot(hh_data) +
  geom_histogram(aes(x = size_1E),
                 fill = "coral",
                 color = "thistle4")

hist02 <- ggplot(hh_data) +
  geom_histogram(aes(x = size_2E),
                 fill = "blue",
                 color = "thistle4")

hist03 <- ggplot(hh_data) +
  geom_histogram(aes(x = size_3E),
                 fill = "white",
                 color = "thistle4")

hist04 <- ggplot(hh_data) +
  geom_histogram(aes(x = size_4E),
                 fill = "red",
                 color = "thistle4")

hist05 <- ggplot(hh_data) +
  geom_histogram(aes(x = size_5E),
                 fill = "green",
                 color = "thistle4")
