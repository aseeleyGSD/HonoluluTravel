...
```{r}
Hi_state_plane <- "+proj=tmerc +lat_0=18.83333333333333 +lon_0=-155.5 +k=0.9999666666666667 +x_0=500000 +y_0=0 +ellps=GRS80 +units=m +no_defs"
```
...
left_side  <- st_bbox(household)$xmin
top_side <- st_bbox(household)$ymax

hh_total_map <- ggplot(household) +
  geom_sf(aes(fill = totE), color=NA)
